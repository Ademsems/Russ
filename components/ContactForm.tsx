          ...
          <motion.div key="form" initial={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-[#E2E8F0] rounded-lg text-sm text-[#1C2033] placeholder-[#94A3B8] focus:outline-none focus:border-[#1E5FBF] focus:ring-1 focus:ring-[#1E5FBF] transition"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-[#1C2033] mb-1.5">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-2.5 border border-[#E2E8F0] rounded-lg text-sm text-[#1C2033] placeholder-[#94A3B8] focus:outline-none focus:border-[#1E5FBF] focus:ring-1 focus:ring-[#1E5FBF] transition resize-none"
              />
            </div>
